...
See the [CLI reference](/reference/cli#init) for a full walkthrough of what each step does.
...
Read the guide on [Generating an SDLC Org Chart](/concepts/org-charts#generating-an-sdlc-org-chart) for the interactive prompt to give your main agent.
