...
description: Enable and configure AOF's memory medallion module — embedding providers, search, and memory pools.
sidebar:
  order: 2
---
...
See [Memory Medallion Architecture](/concepts/memory-medallion) for details on the full pipeline.
