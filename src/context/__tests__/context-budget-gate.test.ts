 ...
 * Current measured total is ~1708 tokens + 25% headroom, rounded to a clean number.
 * If this test fails, someone inflated the context — investigate before bumping.
 */
const BUDGET_CEILING_TOKENS = 2150;
...
describe("context budget gate", () => {
  ...
  it("achieves 50%+ reduction from pre-v1.4 baseline", () => {
