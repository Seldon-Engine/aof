...
- ✅ **v1.10 Codebase Cleanups** — Phases 34-40 (shipped 2026-03-16)
...
<details>
<summary>✅ v1.10 Codebase Cleanups (Phases 34-40) — SHIPPED 2026-03-16</summary>

- [x] Phase 34: Dead Code Removal (2/2 plans) — completed 2026-03-12
- [x] Phase 35: Bug Fixes (2/2 plans) — completed 2026-03-12
- [x] Phase 36: Config Registry (2/2 plans) — completed 2026-03-12
- [x] Phase 37: Structured Logging (3/3 plans) — completed 2026-03-13
- [x] Phase 38: Code Refactoring (3/3 plans) — completed 2026-03-13
- [x] Phase 39: Architecture Fixes (3/3 plans) — completed 2026-03-13
- [x] Phase 40: Test Infrastructure (3/3 plans) — completed 2026-03-16
...
- [x] 43-01-PLAN.md — Wave 0 RED tests: IPC core + dispatch/plugin/migration scaffolding
- [x] 43-02-PLAN.md — Wave 0 integration helpers + 5 RED E2E scenarios (AOF_INTEGRATION=1)
- [x] 43-03-PLAN.md — Wave 1 IPC envelope + /v1/tool/invoke + session-event routes + daemon.mode flag
- [x] 43-04-PLAN.md — Wave 2 SpawnQueue + PluginRegistry + long-poll routes + PluginBridgeAdapter + SelectingAdapter
- [x] 43-05-PLAN.md — Wave 2 wire SelectingAdapter into daemon + assign-executor hold-in-ready (D-12)
- [x] 43-06-PLAN.md — Wave 3 DaemonIpcClient singleton + spawn-poller + runAgentFromSpawnRequest refactor
- [x] 43-07-PLAN.md — Wave 3 gut adapter.ts thin-bridge (D-02 structural invariant) + move project tools to registry
...
- 49E-1: **Inject wake events with the right semantic role.** Today the embedded-run wake path delivers the wake content as `role: "user"` text in the prompt argument; agents are biased toward action when they see user input (observed: woken `swe-architect` tried to call `aof_task_complete` on already-`done` task TASK-2026-05-02-NXWk9aHX, daemon rejected it). Investigate using `runtime.system.enqueueSystemEvent` for ALL wake paths so the wake drains as turn-context (system events), not as user input. Prereq: confirm OpenClaw exposes a "trigger-only run mode" without a heartbeat.
